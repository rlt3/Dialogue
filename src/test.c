 ...
 *
 * Because this function is implemented through call, the first argument on the
 * stack *is* the Dialogue table from the module.
 *
 * From that table it looks for the 'action' field as a function. If it can't
 * find it, it tries to find the 'error' field in the table and send an error.
 *
