...
usage (const char *program)
{
    fprintf(stderr,
        ...
        "       towards the `-w` worker count. If an actor has a worker\n"
        "       requirement of 1 (worker_id of 1 was passed to the actor's\n"
        "       constructor) then that actor's actions will be handled in the\n"
        "       main thread.\n\n"
        "   -l\n"
